...
-- Create function to calculate match results
...
BEGIN
    ...
    WITH team_a_hole_scores AS (
        ...
        LEFT JOIN net_scores ns ON ns.round_id = s.round_id 
    ...
    INSERT INTO match_results (
        ...
        CASE 
            WHEN v_front_nine_winner = 'A' THEN v_match.amount
            WHEN v_front_nine_winner = 'B' THEN -v_match.amount
            ELSE 0
        END,
        CASE 
            WHEN v_back_nine_winner = 'A' THEN v_match.amount
            WHEN v_back_nine_winner = 'B' THEN -v_match.amount
            ELSE 0
        END,
        CASE 
            WHEN v_total_winner = 'A' THEN v_match.amount
            WHEN v_total_winner = 'B' THEN -v_match.amount
            ELSE 0
        END
    );
