/*
  # Results Tables Setup

  1. New Tables
    - `round_results`
      - Stores final positions and payouts for each round
    - `skins`
      - Tracks skins winners and amounts
    - `twos`
      - Records players who scored twos and their payouts
